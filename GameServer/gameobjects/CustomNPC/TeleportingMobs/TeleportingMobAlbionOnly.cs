...
namespace DOL.GS
{
    public class TeleportingMob : GameNPC
    {
        ...
        private const ushort DEST_ZONE = 176;
        private const int DEST_X = 653820;
        private const int DEST_Y = 617334;
        private const int DEST_Z = 9560;
        private const ushort DEST_HEADING = 2063;
