...
{
	/// <summary>
	/// Table which stores all data related to a player gravestone.
	/// </summary>
	[DataTable(TableName="Gravestones")]
	public class DBGravestones : DataObject
	{
		...
		public DBGravestones()
		{
			m_type = "DOL.GS.GameGravestone";
		}
